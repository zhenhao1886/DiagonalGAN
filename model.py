...
class StyledConvBlock(nn.Module):
    ...
    def forward(self, input, style, pix, style2=None,pix2=None):
        out = self.conv1(input)
    ...
    def __init__(self, code_dim, fused=True):
        ...
        self.progression = nn.ModuleList(
            [
                ...
                StyledConvBlock(64, 32, 3, 1, img_dim = 512,upsample=True,fused=True,use_att=False),
                StyledConvBlock(32, 16, 3, 1, img_dim = 1024,upsample=True,fused=True,use_att=False),
            ]
        )
...
#                 noise.append(torch.randn(batch, 1, size, size, device=input[0].device))
        ...
        return self.generator(styles, pix, step, alpha)
